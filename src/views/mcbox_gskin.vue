    ...
    <div style="display: flex; justify-content: center">
      <div class="canvasskin">
        ...
        <div class="availableAnimations iconfont">
          <div
            v-show="this.availableAnimations == 1"
            v-on:click="skin_availableAnimations(2)"
          >
            &#xe610;
          </div>
          <div
            v-show="this.availableAnimations == 2"
            v-on:click="skin_availableAnimations(3)"
          >
            &#xe661;
          </div>
          <div
            v-show="this.availableAnimations == 3"
            v-on:click="skin_availableAnimations(4)"
          >
            &#xe636;
          </div>
          <div
            v-show="this.availableAnimations == 4"
            v-on:click="skin_availableAnimations(1)"
          >
            &#xe6a8;
          </div>
        </div>
...
<script>
import skinview3d from "@/../public/js/gskin/skinview3d.bundle";
  ...
  methods: {
    skinview() {
      ...
      let skinViewer = new skinview3d.SkinViewer({
        ...
        width: 300,
        height: 400,
        skin: require("../../public/img/gskin/steve.png"),
      });
      skinViewer
        .loadSkin(skinurl, {
          model: "auto-detect",
